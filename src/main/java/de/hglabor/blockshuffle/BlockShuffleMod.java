...
public class BlockShuffleMod implements ModInitializer {
    ...
    public final static List<Material> ALLOWED_MATERIAL = Arrays.asList(Material.METAL, Material.WOOD,
            Material.SOLID_ORGANIC, Material.SOIL, Material.DENSE_ICE, Material.WOOL, Material.LEAVES, Material.ORGANIC_PRODUCT,
            Material.STONE, Material.GOURD, Material.AGGREGATE, Material.COBWEB, Material.SPONGE, Material.NETHER_WOOD, Material.GLASS, Material.ICE);
