...
public class BadlandsSurfaceBuilderMixin extends SurfaceBuilder<TernarySurfaceConfig> {
   ...
   public BadlandsSurfaceBuilderMixin(Codec<TernarySurfaceConfig> codec) {
      super(codec);
   }
   ...
   public void initLayerBlocks(long seed) {
   ...
   public BlockState calculateLayerBlockState(int x, int y, int z) {
      int i = (int)Math.round(this.layerNoise.sample((double)x / 512.0D, (double)z / 512.0D, false) * 2.0D);
      return this.layerBlocks[(y + i + 64) % 64];
   }

   static {
      WHITE_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.WHITE_TERRACOTTA, Blocks.WHITE_TERRACOTTA).getDefaultState();
      ORANGE_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.ORANGE_TERRACOTTA, Blocks.ORANGE_TERRACOTTA).getDefaultState();
      TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.TERRACOTTA, Blocks.TERRACOTTA).getDefaultState();
      YELLOW_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.YELLOW_TERRACOTTA, Blocks.YELLOW_TERRACOTTA).getDefaultState();
      BROWN_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.BROWN_TERRACOTTA, Blocks.BROWN_TERRACOTTA).getDefaultState();
      LIGHT_GRAY_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA).getDefaultState();
      RED_TERRACOTTA = BlockShuffleMod.BLOCK_PAIRS.getOrDefault(Blocks.RED_TERRACOTTA, Blocks.RED_TERRACOTTA).getDefaultState();
   }
}
